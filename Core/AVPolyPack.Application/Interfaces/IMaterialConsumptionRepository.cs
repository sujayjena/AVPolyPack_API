...
namespace AVPolyPack.Application.Interfaces
{
    public interface IMaterialConsumptionRepository
    {
        ...
        Task<IEnumerable<ConsumptionHeader_Response>> GetConsumptionHeaderList(Consumption_Search parameters);
        ...
        Task<IEnumerable<WasteMaterialHeader_Response>> GetWasteMaterialHeaderList(WasteMaterial_Search parameters);
