...
namespace AVPolyPack.Controllers
{
    ...
    public class ContactDetailController : CustomBaseController
    {
        ...
        public async Task<ResponseModel> SaveContactDetail(ContactDetail_Request parameters)
        {
            ...
            {
                var vUploadFile_PanCard = _fileManager.UploadDocumentsBase64ToFile(parameters.PanCardImage_Base64, "\\Uploads\\" + parameters.RefType + "\\", parameters.PanCardOriginalFileName);
