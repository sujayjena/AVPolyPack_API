using AVPolyPack.API.CustomAttributes;
using AVPolyPack.Application.Constants;
using AVPolyPack.Application.Enums;
using AVPolyPack.Application.Helpers;
using AVPolyPack.Application.Interfaces;
using AVPolyPack.Application.Models;
using AVPolyPack.Helpers;
    ...
    public class LoginController : ControllerBase
    {
        ...
        */
        ...
        public async Task<ResponseModel> Login(LoginByMobileNumberRequestModel parameters)
        {
            ...
            {
                if (Convert.ToDateTime(DateTime.Now) < Convert.ToDateTime("2026-07-30"))
                {
