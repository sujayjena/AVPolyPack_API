...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "AVPolyPack API", Version = "v1" });
...
//Web Application related configurations
{
    ...
    app.UseSwaggerUI(s =>
    {
        s.SwaggerEndpoint("/swagger/v1/swagger.json", "AVPolyPack API");
